...
public:
    ...
    {            
        ...
        vehicle_ = new DIABLO::OSDK::Vehicle(&Hal); // Initialize Onboard SDK
        if (vehicle_->init())
            return -1;
        ...
        movement_ctrl_=vehicle_->movement_ctrl;
    ...
    void teleopCtrlCallBack(const std_msgs::String::ConstPtr &msg)
    {
        ...
        InfoUpdateAndCtrl::publishDataProcess();
    }

    void publishDataProcess()
    {
